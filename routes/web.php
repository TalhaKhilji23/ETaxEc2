...
Route::get('/registration/salestax', 'App\Http\Controllers\SalesTaxcontroller@index')->middleware('auth');
Route::post('/registration/incometax', 'App\Http\Controllers\IncomeTaxController@register');
Route::post('/registration/salestax', 'App\Http\Controllers\SalesTaxcontroller@registerSalesTax');
